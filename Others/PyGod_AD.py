...
def train_test_model(dataset, alpha, eta, ratio):
    ...
    detector = AnomalyDAE(hid_dim=64, num_layers=4, epoch=100, alpha=alpha, eta=eta, theta=10)
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        output_file_0 = open(f'Output/AnomalyDAE/AnomalyDAE-{dataset}.txt', 'w')
        first_line = 'seed,alpha,eta,AUC,CST,CST_equal,CST_base,loss_start_epoch,loss_end_epoch'
        ...
        for alpha in alphas:
            for eta in etas:
                ...
                start_time = time.time()
                    # Padding args
                seed = f'{seed_number},'
                current_hp = f'{alpha},{eta},'

                AUC,cs,cse,ccsb,first_loss_value,last_loss_value,ano_score_final = train_test_model(dataset=dataset, alpha=alpha,eta=eta,ratio=ratio)
                ...
                col_name = f'{seed_number},{alpha},{eta}'
        ...
        csv_filename = f'Output/AnomalyDAE/anomaly_scores_{dataset}.csv'
