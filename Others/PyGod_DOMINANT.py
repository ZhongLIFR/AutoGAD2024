...
def train_test_model(dataset, weight, ratio):
    ...
    # detector = CONAD(hid_a=64, num_layers=4, epoch=100 ,weight=weight, eta=0.5, margin=0.5, r=0.2, m=50, k=50, f=10, sigmoid_s=True)
    # -----------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    for dataset in datasets:
        ...
        output_file_0 = open(f'Output/DOMINANT/DOMINANT-{dataset}.txt', 'w')
        first_line = 'seed,alpha,AUC,CST,CST_equal,CST_base,loss_start_epoch,loss_end_epoch'
        ...
        for weight in weights:
            ...
            AUC,cs,cse,ccsb,first_loss_value,last_loss_value,ano_score_final = train_test_model(dataset=dataset, weight=weight,ratio=ratio)
        ...
        csv_filename = f'Output/DOMINANT/anomaly_scores_{dataset}.csv'
